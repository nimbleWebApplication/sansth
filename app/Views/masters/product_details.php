          ...
          <div class="row">
              ...
              <div class="card">
                ...
                <div class="card-body table-responsive p-0" >
                  <table class="table table-head-fixed text-nowrap table-striped table-bordered">
                    ...
                    <?php } else{ $i=0; foreach (array_reverse($products) as $product) { ?>
                        <tr>
                          <td><center><?php echo ++$i;?></center></td>
                          <td><?php echo $product['product_name']; ?></td>                         
                          <td><center><a href="#"><span class="btn btn-primary btn-sm"><i class="fa fa-trash fa-sm" title="Edit Customer"></i></span></a></center></td>
                        </tr>
                    <?php } } ?>			
                    </tbody>
                  </table>
            ...
            <div class="col-6">
              <div class="card">
                ...
                <!-- /.card-header -->
                <form role="form" id="masterData" method="post" action="<?= site_url('master/products'); ?>">
