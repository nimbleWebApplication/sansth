        ...
        <div class="container">
          <div class="row">
              ...
              <div class="card">
                ...
                <div class="card-body table-responsive p-0" >
                  <table class="table table-head-fixed text-nowrap table-striped table-bordered">
                    ...
                    <?php } else{ $i=0; foreach (array_reverse($eligibility) as $el) { ?>
                        <tr>
                          <td><center><?php echo ++$i;?></center></td>
                          <td><?php echo $el['el_name']; ?></td>                         
            ...
            <div class="col-6">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">New Eligibility Criteria</h3>
                </div>
                <!-- /.card-header -->
                <form role="form" id="masterData" method="post" action="<?= site_url('master/eligibility'); ?>">
                      ...
                      <div class="row">
                        <div class="col-sm-8">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Name ..." name="el_name">
                          </div>
                        </div>
                      </div>
                    </div>
