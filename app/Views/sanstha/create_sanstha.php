				...
				<div class="col-md-12">
					...
					<form role="form" id="createBid" method="post" action="<?= site_url('sanstha/create_sanstha'); ?>">
						<div class="card-body" style="padding: 0.25rem;">
							...
							<fieldset style="border: 1px solid #d3d3d3;padding: 1.25rem;background-color: #FFF"><h4>3. Sanstha Information</h4>
								<div class="row">
									<div class="col-sm-3">
										<!-- text input -->
										<div class="form-group">
							...
							<fieldset style="border: 1px solid #d3d3d3;padding: 1.25rem;background-color: #FFF"><h4>6. Membership Details</h4>
								<div class="row">
									<div class="col-sm-3">
										<!-- text input -->
										<div class="form-group">
