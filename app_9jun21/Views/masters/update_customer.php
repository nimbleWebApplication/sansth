			...
			<div class="row" id="import_profiles">
				<div class="col-md-12">
					...
					<div class="card card-primary">
						...
						<!-- /.card-header -->
						<form role="form" id="createCustomer" method="post" action="<?= site_url('master/update_customer_save'); ?>">
							<div class="card-body">
								<div class="row">
									<div class="col-sm-3">
										<!-- text input -->
										<div class="form-group">
											...
											<input type="text" class="form-control" placeholder="name..." name="client_id" value="<?php echo $customer_details[0]['client_id']; ?>">
											<input type="text" class="form-control" placeholder="name..." name="lead_id" value="<?php echo $lead_details[0]['lead_id']; ?>">
										</div>
									</div>
									<div class="col-sm-3">
										<div class="form-group">
								...
								<div class="row hidden" style="background-color: #007bff1c;border-radius: calc(.25rem - 1px) calc(.25rem - 1px) 0 0; padding: 5px;">
									<div class="col-sm-12" >
